...
if __name__ == '__main__':
    ...
    dloader = torch.utils.data.DataLoader(MRBrainSDataset(osp.join('../MRBrainS', 'MRBrainS'), split='train', is_transform=True, img_norm=True, augmentations=data_aug), batch_size=1)
